...
namespace BetterJoyForDolphin {
	public class Joycon {
        ...
        public EventHandler configAction;
        ...
        public void SetPack(int port, int force = 10, int[] invertArray = null) {
            if (uPDPack != null) uPDPack.CloseSock();
            uPDPack = new JoyUPDPack(this,port, ip : ConfigurationManager.AppSettings["IP"], force: force, invertArray: invertArray);
        }

        public JoyUPDPack GetPack() {
            return uPDPack;
        }

        public void SetActiveOtherPack(bool active)
        {
            other.GetPack().SetActive(active);
        }

        public void SendPackage() {
             if(uPDPack.GetPack(this.GetAccel()) != null) 
             uPDPack.SendPack();
        }

        public void SendUdpPack() {
            uPDPack.SendPack();
        }
